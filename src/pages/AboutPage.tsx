    ...
    >
      <div className="px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto mt-8 max-w-3xl text-center">
          <h1 className="text-3xl font-bold mb-4 text-cyan-400">About Us</h1>
          <p className="text-lg text-cyan-100/80">Ecom is dedicated to providing the best tech gear and immersive shopping experiences. Our team curates the latest and greatest in electronics, ensuring quality and satisfaction for every customer. Thank you for being part of our journey!</p>
        </div>
      </div>
    </section>
  );
