    ...
    >
      <div className="px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto mt-8 max-w-3xl text-center">
          <h1 className="text-3xl font-bold mb-4 text-cyan-400">Help Center</h1>
          <p className="text-lg text-cyan-100/80">Need assistance? Browse our FAQs or contact our support team for help with orders, products, or your account. We're here to make your experience seamless!</p>
        </div>
      </div>
    </section>
  )
